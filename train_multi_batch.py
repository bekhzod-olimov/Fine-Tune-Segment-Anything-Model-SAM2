...
# python train_multi_batch.py --data_dir /mnt/data/segmentation/LabPicsV1/ --checkpoint_path ../backup/checkpoints/sam2_hiera_small.pt --model_cfg sam2_hiera_s.yaml